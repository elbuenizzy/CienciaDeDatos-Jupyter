...
class churnForm():
    ...
    def index():
        ...
        if request.method == 'POST':
            ...
            payload_scoring = {"fields": input_data, "values": [input_values]}
            print("Payload is: ")
            ...
            result_keys = result_json['fields']
            result_vals = result_json['values']
            ...
            flash('La probabilidad de CHURN es de: %.0f%%'
                  % yes_percent)
